                            ...
                            children: [
                              Expanded(
                                child: TextFieldWidget(
                                  ...
                                  isEnable: !(controller.obra.statusGeometria !=
                            ...
                            children: [
                              Expanded(
                                child: TextFieldWidget(
                                  ...
                                  hintText: 'Por extenso. Ex: Avenida São João',
                                  isEnable: !(controller.obra.statusGeometria !=
                                      StatusGeometriaEnum.APROVADO),
                                  inputFormatters: [
                            ...
                            children: [
                              Expanded(
                                child: DropDownFieldWidget<SubprefeituraEnum>(
                                  ...
                                  validation: controller.validateSubprefeitura,
                              ...
                              Expanded(
                                child: TextFieldWidget(
                                  title: 'Extensão (m)',
                                  initialValue: controller.obraUpdated.extensao,
                                  inputFormatters: [
                                    FilteringTextInputFormatter.allow(
                                        RegExp("[0-9,]")),
                                  ],
